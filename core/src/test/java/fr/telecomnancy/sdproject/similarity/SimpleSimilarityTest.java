...
public class SimpleSimilarityTest {
    ...
    @Test
    public void testMovieSmilirality() {
        MovieSimilirality similiraty = new SimpleSimilarility();
        Assert.assertEquals("No similiraties between the two movies", similiraty.smilarility(movie1, movie2), 5);
    }
